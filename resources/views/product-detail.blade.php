                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ app()->getLocale() == 'en' ? '/en/products' : '/id/produk' }}" class="ml-1 text-sm font-medium {{ $theme === 'dark' ? 'text-white' : 'text-gray-700' }} hover:text-custom-green">
                                {{ __('general.products') }}
                            </a>
                        </div>
                    </li>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="product-item {{ $theme === 'dark' ? 'bg-gray-400' : 'bg-gray-200' }} rounded-lg shadow-sm flex flex-col border border-gray-200 overflow-hidden max-w-xs mx-auto w-full"
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <a href="{{ app()->getLocale() == 'en' ? '/en/product/' . $randomProduct->slug : '/id/product/' . $randomProduct->slug }}" class="hover:text-custom-red">

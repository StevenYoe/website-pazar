                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ url('/products') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-custom-green md:ml-2 dark:text-gray-300 dark:hover:text-custom-green">Products</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ $product->p_title_id }}</span>
                        </div>
                    </li>
                </ol>
            </nav>

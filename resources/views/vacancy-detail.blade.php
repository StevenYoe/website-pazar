                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ app()->getLocale() == 'en' ? '/en/vacancies' : '/id/lowongan' }}" class="ml-1 text-sm font-medium {{ $theme === 'dark' ? 'text-white' : 'text-gray-700' }} hover:text-custom-green">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="vacancy-item bg-white dark:bg-gray-300 rounded-lg shadow-sm flex flex-col border border-gray-200 overflow-hidden"
                                ...
                                <div class="p-6 flex flex-col card-container">
                                    ...
                                    <a href="{{ app()->getLocale() == 'en' ? '/en/vacancy/' . $related->slug : '/id/vacancy/' . $related->slug }}" class="text-custom-green hover:text-custom-lightergreen font-medium text-sm self-end">
                                        {{ __('general.see_more') }} →
                                    </a>
                                </div>
                            </div>

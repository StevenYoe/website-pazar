    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ url('/recipes') }}" class="ml-1 text-sm font-medium {{ $theme === 'dark' ? 'text-gray-300' : 'text-gray-700' }} hover:text-custom-green">Recipes</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium {{ $theme === 'dark' ? 'text-gray-500' : 'text-black' }} md:ml-2">{{ $recipe->r_title_id }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="lg:flex lg:items-start lg:space-x-8">
            ...
            <div class="mt-10 lg:mt-0 lg:w-1/2">
                <div class="pb-2">
                    <h1 class="text-3xl {{ $theme === 'dark' ? 'text-white' : 'text-gray-900' }}">{{ $recipe->r_title_id }}</h1>
        ...
        <div class="mt-16 recipe-section">
            <h2 class="text-2xl font-bold text-center {{ $theme === 'dark' ? 'text-white' : 'text-gray-900' }} mb-8">Resep Lainnya</h2>
